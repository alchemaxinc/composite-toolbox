# Sync Tags in Documentation (deprecated) :warning:

> [!WARNING]
> This action is deprecated in favor of
> [`sync-action-tag-in-docs`](../sync-action-tag-in-docs/), which has an
...
> `alchemaxinc/composite-toolbox/sync-action-tag-in-docs@v1.24.1` directly.
